...
* [Пример реализации собственной Writeable обертки](https://hadoop.apache.org/docs/r3.0.1/api/org/apache/hadoop/io/Writable.html)
* [Пример реализации собственной WriteableComparable обертки](https://hadoop.apache.org/docs/r3.0.1/api/org/apache/hadoop/io/WritableComparable.html)

##### Сборка и запуск программмы
Собирать Java-проект можно с помощью ant или maven. См. соответственно build.xml и pom.xml в `examples/03-word-count-java-api`.
